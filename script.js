(() => {
  ...
  finalizeBtn.addEventListener('click', () => {
    const rec = receivedRaw;
    // Validation: required received
    if (!receivedEl.value) {
      messageEl.textContent = 'Preencha o valor a receber';
      messageEl.className = 'message error';
      return;
    }
    ...
    messageEl.textContent = 'Venda finalizada';
    messageEl.className = 'message success';
    setTimeout(() => {
...
(function() {
  ...
  toggle.addEventListener('pointermove', e => {
    ...
    toggle.style.left = origX + dx + 'px';
    toggle.style.top = origY + dy + 'px';
  });
