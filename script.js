(() => {
  ...
  function showKeypad(input,m){
    activeInput=input;mode=m;buffer='';display.textContent='';main=document.querySelector('main');main.style.paddingBottom=keypad.offsetHeight+'px';
    keypad.classList.remove('hidden');
  }
  function hideKeypad(){keypad.classList.add('hidden');document.querySelector('main').style.paddingBottom='';clearError();}
  ...
  products.forEach(prod=>{
    ...
    prod.querySelector('.pencil').addEventListener('click',()=>{inpt.value=prod.querySelector('.count').textContent;showKeypad(inpt,'integer');});
