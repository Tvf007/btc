(() => {
  ...
  function showKeypad(input, mode){ activeInput=input; activeMode=mode; inputBuffer=''; display.textContent=''; keypad.classList.remove('hidden'); }
  function hideKeypad(){ keypad.classList.add('hidden'); clearError(); }
